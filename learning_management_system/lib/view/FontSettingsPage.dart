          ...
          children: [
            Row(
              children: [
                IconButton(
                  onPressed: () {
                    controller.updateFontSize(delta - 0.5);
                    Get.forceAppUpdate();
                  },
                  icon: Icon(
                ...
                children: [
                  Text(
                    ...
                    style: TextStyle(
                      ...
                      fontSize:
                          globalFontSizeChange <= 17
                              ? (globalFontSizeChange / 5) + fontSize
                              : fontSize - (globalFontSizeChange / 5),
