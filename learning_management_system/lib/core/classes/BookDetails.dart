...
class _BookDetailsState extends State<BookDetails> {
  ...
  Widget build(BuildContext context) {
    ...
    final featuredRatings = widget.BookData["FeaturedRatings"] as List<dynamic>? ?? [];
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        body: widget.BookData == null || widget.BookData.isEmpty
            ? Center(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Column(
                                    children: [
                                      Text(
                                        "Author: ${widget.BookData["author"]}".tr,
                                        style: TextStyle(
                                          fontSize: 16,
                                      ...
                                      SizedBox(height: 5),
                                      Text(
                                        "Publish Date: ${widget.BookData["publish date"]}".tr,
                                        style: TextStyle(
                                          fontSize: 14,
                                          fontWeight: FontWeight.w300,
                                          fontStyle: FontStyle.normal,
                                        ...
                                        child: Container(
                                          ...
                                          child: ElevatedButton(
                                            onPressed: () async {
                                              ...
                                              try {
                                                  final PDFurl = widget.BookData['url'];
                                      ...
                                      children: [
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                widget.BookData["literaryOrScientific"] == 1
                                                  ? "(Scientific)".tr
                                                  : "(Literary)".tr,
                                                style: TextStyle(
                                                  fontSize: 12,
                          ...
                          Center(
                            child: Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "  ${widget.BookData["rating"].toString()}  (${widget.BookData["rating"].toString()})",
                                  style: TextStyle(
                                    color: themeController.initialTheme == Themes.customLightTheme
                                        ? Color.fromARGB(255, 40, 41, 61)
                                        : Color.fromARGB(255, 210, 209, 224),
                                  ...
                                  builder: (context, setState) {
                                    ...
                                    return Column(
                                      ...
                                      children: [
                                          ...
                                          children: [
                                            Expanded(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  Text(
                                                    review["user_name"]?.toString().tr ?? ''.tr,
                                                    style: TextStyle(
                                                      color: themeController.initialTheme == Themes.customLightTheme
                                                          ? Color.fromARGB(255, 40, 41, 61)
                                                          : Color.fromARGB(255, 210, 209, 224),
                                                  ...
                                                  Row(
                                                    children: [
                                                      ...
                                                      Text(
                                                        review["rating"]?.toString().tr ?? 'no rating'.tr,
                                                        style: TextStyle(
                                                          color: themeController.initialTheme == Themes.customLightTheme
                                                              ? Color.fromARGB(255, 40, 41, 61)
                                                              : Color.fromARGB(255, 210, 209, 224),
                                            ...
                                            Expanded(
                                              flex: 1,
                                              child: Text(
                                                review["updated_at"]?.toString().tr ?? ''.tr,
                                                style: TextStyle(
                                                  color: themeController.initialTheme == Themes.customLightTheme
                                                      ? Color.fromARGB(255, 40, 41, 61)
                                                      : Color.fromARGB(255, 210, 209, 224),
                                        ...
                                        if (index < featuredRatings.length - 1)
                                          Container(
                                            height: 1,
