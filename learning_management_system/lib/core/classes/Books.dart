...
class _BooksState extends State<Books> {
  ...
  Future<void> _loadCachedData() async {
    try {
      final cachedRecommended = sharedPrefs.prefs.getString('cached_books');
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child: ClipRRect(
                                                        ...
                                                        child:
                                                            widget.books[i]['image'] !=
                                                                    null
                                                                ? CachedNetworkImage(
                                                                  imageUrl:
                                                                      "$mainIP/${widget.books[i]['image']}",
                                                                  height: 60,
                                                                  width: 60,
                                                                )
                                                                : Image.asset(
