...
class _AvatarPickerState extends State<AvatarPicker> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<AvatarModel> avatarList = [
      AvatarModel(id: 0, avatar: ImageAssets.AppLogo),
      AvatarModel(id: 1, avatar: ImageAssets.Avatar1),
      AvatarModel(id: 2, avatar: ImageAssets.Avatar2),
      AvatarModel(id: 3, avatar: ImageAssets.Avatar3),
      AvatarModel(id: 4, avatar: ImageAssets.Avatar4),
      AvatarModel(id: 5, avatar: ImageAssets.Avatar5),
      AvatarModel(id: 6, avatar: ImageAssets.Avatar6),
      AvatarModel(id: 7, avatar: ImageAssets.Avatar7),
      AvatarModel(id: 8, avatar: ImageAssets.Avatar8),
      AvatarModel(id: 9, avatar: ImageAssets.Avatar9),
    ];
