...
import 'package:learning_management_system/controller/TimerController.dart';
...
class TimerView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    PomodoroController controller = Get.put(PomodoroController(),permanent: true);
  ...
  String _getPhaseName(String phase) {
    switch (phase) {
      ...
      case 'Short Break': return 'Short Break ☕️';
  ...
  Color _getPhaseColor(String phase) {
    switch (phase) {
      ...
      case 'Short Break': return Colors.green;
