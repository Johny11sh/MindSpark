...
class _CoursesState extends State<Courses> {
  ...
  Future<void> _loadCachedData() async {
    try {
      // Load  courses data
      final CachedCourses = sharedPrefs.prefs.getString('cached_courses');
      if (CachedCourses != null) {
        final List<dynamic> parsedRecommendedList = jsonDecode(CachedCourses);
  ...
  // Future<void> _cacheCourseImage(int bookId, Uint8List imageBytes) async {
  //   try {
  //     await sharedPrefs.prefs.setString(
  //       'book_image_$bookId',
