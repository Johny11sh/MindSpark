      ...
      try {
        ...
        final response = await http
            .put(
              ...
              body: jsonEncode({
                'number': numberController.text.trim().replaceFirst(
                  RegExp(r'0'),
                  '',
                ),
              }),
                                    ...
                                    validator: (val) {
                                      if (val!.isEmpty) {
                                        ...
                                        if (val !=
                                          ...
                                          return "Old number must match your last used number"
                                              .tr;
                                        }
                                        return null;
                                      }
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: (val) {
                                      if (val!.isEmpty) {
                                        ...
                                        if (val == oldNumberController.text) {
                                          return "Old and New numbers can not match!"
                                              .tr;
                                        }
                                        return null;
                                      }
